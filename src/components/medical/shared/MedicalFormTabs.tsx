...
interface MedicalFormTabsProps {
  tabs: TabData[];
  activeTab: string;
...
export const MedicalFormTabs: React.FC<MedicalFormTabsProps> = ({
  tabs,
  activeTab,
  onTabChange,
  onPreview,
        ...
        <div className="flex items-center justify-between">
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap flex items-center space-x-2 transition-all duration-200 ${
                  activeTab === tab.id
                    ? 'border-teal-500 text-teal-600 dark:text-teal-400 dark:border-teal-500'
          ...
          {onPreview && (
            <Button
              ...
              size="sm"
              onClick={onPreview}
              className="flex items-center space-x-2 bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-400"
            >
