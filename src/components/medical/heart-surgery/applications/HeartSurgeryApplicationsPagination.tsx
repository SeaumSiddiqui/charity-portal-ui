...
interface HeartSurgeryApplicationsPaginationProps {
  pageData: PageResponse<MedicalApplicationSummaryDTO>;
  onPageChange: (page: number) => void;
}

export const HeartSurgeryApplicationsPagination: React.FC<HeartSurgeryApplicationsPaginationProps> = ({
  pageData,
  onPageChange
}) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              placeholder="Page"
              className="w-16 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-1 focus:ring-teal-500 focus:border-teal-500"
            />
            <Button
              variant="outline"
              size="sm"
